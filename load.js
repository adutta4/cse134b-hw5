    ...
    const jsonProjects = [
        {
            ...
            "secondary_image": "https://pub-6ad496500cf0446fa228dd29a115090f.r2.dev/ecdna-small%20(1).png",
        ...
        },
        {
            ...
            "secondary_image": "https://pub-6ad496500cf0446fa228dd29a115090f.r2.dev/tc-logo-new%20(1).png",
            "image_description": "Triton Cook app screenshot",
        ...
        },
        {
            ...
            "secondary_image": "https://pub-6ad496500cf0446fa228dd29a115090f.r2.dev/coding-small.jpg",
            "image_description": "Code on computer screen",
            "extra_link": "https://vert-one.com/",
            "link_name": "Vert Finance website"
        },
        {
            "project_name": "Lab Intern at Schimmel-Yang Lab (2020-2021)",
            "description": "Worked in both wet lab and dry lab settings. Ran bioinformatics analyses on large datasets (TCGA - The Cancer Genome Atlas) to find the impact of tRNA synthetase mutations on cancer. Also worked in the wet lab to conduct Western blots, protein purification, and others.",
            "image": "https://pub-6ad496500cf0446fa228dd29a115090f.r2.dev/aars.jpg",
            "secondary_image": "https://pub-6ad496500cf0446fa228dd29a115090f.r2.dev/aars-small-mod%20(1).jpg",
            "image_description": "Model of tRNA synthetase",
            "extra_link": "https://www.scripps.edu/schimmel/",
            "link_name": "Schimmel-Yang Lab website"
        }
    ];
...
loadLocalButton.addEventListener("click", (event) => {
    ...
    try {
        projectList.forEach(proj => {
            ...
            window.newProject.setAttribute("secondary-image", proj.secondary_image);
